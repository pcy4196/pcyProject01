			...
			<div class="carousel-inner" role="listbox">
				<div class="item active" align="center">
					...
					<div class="carousel-caption">
						<h2>NBA Player들의 사진 및 GIF <br />파일을 등록하는 Page 입니다</h2>
						<p>- Gallery Create -</p>
					</div>
				</div>
			</div>
...
<div class="card">
 <form id="galleryCreate" class="form-horizontal" action="galleryCreateProc.do" method="post" enctype="multipart/form-data" onsubmit="return checkFile();" >
 	...
 	<div class="content">
         ...
         <fieldset>
             <div class="form-group" >
                 ...
                 <div class="col-sm-4">
                     <input class="form-control" type="text" id="wname" name="wname" required="required" readonly="readonly" value="${sessionScope.id}"/>
                 </div>
                 <div class="col-sm-4">                 		
         ...
         <fieldset>
             <div class="form-group" >
                 ...
                 <div class="col-sm-8">
                     <input class="form-control" type="text" id="content" name="content" required="required" />
                 </div>                 
