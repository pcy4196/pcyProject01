...
<div class="card">
 <form id="frmFAP" name="frmFAP" class="form-horizontal" action="fanPageCreate.do" method="post" onsubmit="return check();">
 	<input type="hidden" name="page" value="${param.page}">
 	<input type="hidden" name="wname" value="${sessionScope.id}">
         ...
         <fieldset>
			<div class="form-group">
				...
				<div class="col-sm-10 text-center">
					<textarea rows="10" id="content" name="content" style="width: 100%;" placeholder="내용란"></textarea>
				</div>                
			</div>			 
         </fieldset> 
